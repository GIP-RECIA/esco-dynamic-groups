    ...
    public String toString() {
        if (stringRepresentation == null) {
            ...
            if (choice == REFRESH_PRESENT) {
                stringRepresentation += "REFRESH_PRESENT, " + cookie + ", " + refreshDone + "}";
            } else if (choice == REFRESH_DELETE) {
                stringRepresentation += "REFRESH_DELETE, " + cookie + ", " + refreshDone + "}";
            } else if (choice == NEW_COOKIE ) {
                stringRepresentation += "NEW COOKIE, " + cookie + "}";
            } else if (choice == SYNC_ID_SET) {
                stringRepresentation += "SYNC_ID_SET, " + cookie + ", " + refreshDeletes + "}";
            }
        }
